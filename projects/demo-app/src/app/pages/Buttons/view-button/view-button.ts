...
export class ViewButton {
  ...
  exampleSizes = `
  <magary-button label="Small" size="small" severity="primary"></magary-button>
  ...
  <!-- Con íconos -->
  <magary-button icon="fas fa-star" size="small" severity="success"></magary-button>
  <magary-button icon="fas fa-star" size="normal" severity="success"></magary-button>
  <magary-button icon="fas fa-star" size="large" severity="success"></magary-button>`;
  exampleVariants = `
